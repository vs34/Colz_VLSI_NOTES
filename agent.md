...
## 📂 Naming Scheme of the Slides

In each course directory, the PDF slides are organized in the `lecture/` folder and named chronologically and topically according to the following scheme:
`Week_XX_Lecture_YY_Topic_Inside_Name.pdf`

Example:
`Week_01_Lecture_01_Course_Overview_and_Energy_Bands_Introduction.pdf`
...
2. **Locate**: Find the lecture code (e.g., `W4 L1`) or matching slide titles for the user's keywords.
3. **Inspect**: Open the specific PDF file in that course's `lecture/` folder.
